...
{
    [Header("Level Info")] public string levelName = "New Level";

    [TextArea(2, 4)] public string levelDescription;

    [Header("Grid Configuration")] public GridConfiguration gridConfig = new();

    [Header("Terrain Generation")] public Vector2Int mapSize = new(50, 50);
    ...
    [Header("Lake Generation")] public bool generateLakes = true;

    public int lakeCount = 2;
    public int minLakeSize = 3;
    public int maxLakeSize = 8;

    [Header("Tile Assets")] public NormalTile[] grassTiles;

    public NormalTile[] stoneTiles;
    public NormalTile[] sandTiles;
    public WaterTile[] waterTiles;

    [Header("Environment")] public WeatherCondition defaultWeather = WeatherCondition.Sunny;
